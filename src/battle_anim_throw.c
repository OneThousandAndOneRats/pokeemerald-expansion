...
#define TAG_PARTICLES_DELTABALL   65058
...
static const struct CompressedSpriteSheet sBallParticleSpriteSheets[] =
{
    ...
    [BALL_DELTA]    = {gBattleAnimSpriteGfx_Particles2,     0x100, TAG_PARTICLES_DELTABALL},
};
...
static const struct CompressedSpritePalette sBallParticlePalettes[] =
{
    ...
    [BALL_DELTA]    = {gBattleAnimSpritePal_Particles2,     TAG_PARTICLES_DELTABALL},
};
...
static const TaskFunc sBallParticleAnimationFuncs[POKEBALL_COUNT] =
{
    ...
    [BALL_DELTA]   = SafariBallOpenParticleAnimation,
};
...
static const struct SpriteTemplate sBallParticleSpriteTemplates[POKEBALL_COUNT] =
{
    ...
    [BALL_DELTA] = {
        .tileTag = TAG_PARTICLES_DELTABALL,
        .paletteTag = TAG_PARTICLES_DELTABALL,
        .oam = &gOamData_AffineOff_ObjNormal_8x8,
        .anims = sAnims_BallParticles,
        .images = NULL,
        .affineAnims = gDummySpriteAffineAnimTable,
