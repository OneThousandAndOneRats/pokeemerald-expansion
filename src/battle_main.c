    ...
    case BATTLE_INTRO_STATE_DRAW_SPRITES:
        for (battler = 0; battler < gBattlersCount; battler++)
        {
            ...
            else
            {
                ...
                gBattleMons[battler].types[0] = gBattleMons[battler].isDelta ? gBattleMons[battler].deltaType1 : gSpeciesInfo[gBattleMons[battler].species].types[0];
                gBattleMons[battler].types[1] = gBattleMons[battler].isDelta ? gBattleMons[battler].deltaType2 : gSpeciesInfo[gBattleMons[battler].species].types[1];
                gBattleMons[battler].types[2] = TYPE_MYSTERY;
