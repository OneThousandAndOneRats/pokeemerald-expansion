    ...
    case 4: // Copy battler data gotten in cases 0 and 1. Draw trainer/mon sprite.
        for (battler = 0; battler < gBattlersCount; battler++)
        {
            ...
            else
            {
                ...
                gBattleMons[battler].type1 = gBattleMons[battler].isDelta ? gBattleMons[battler].deltaType1 : gSpeciesInfo[gBattleMons[battler].species].types[0];
                gBattleMons[battler].type2 = gBattleMons[battler].isDelta ? gBattleMons[battler].deltaType2 : gSpeciesInfo[gBattleMons[battler].species].types[1];
                gBattleMons[battler].type3 = TYPE_MYSTERY;
